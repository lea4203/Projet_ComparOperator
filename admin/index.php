...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="container col-8 align-item-center pb-3 border-bottom border-secondary">
            ...
            <a href="form_ajout_destination.php" class="btn btn-primary text-white" style="color: #051c55">Ajouter une
                destination</a>
        </div>
        ...
        <div class="container col-8 align-item-center pt-3 pb-3 mb-5border-bottom border-secondary">
            ...
            <a href="form_ajout_tour_operator.php" class="btn btn-primary text-white" style="color: #051c55">Ajouter une
                Tour Opérateur</a>
        </div>
