    ...
    <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ms-auto">
                    <li class="nav-item"><a class="nav-link" href="index.php"><strong>Destinations</strong></a></li>
                    <li class="nav-item"><a class="nav-link" href="tours_operators.php"><strong>Tours Operators</strong></a></li>
                    <li class="nav-item"><a class="nav-link" href="#services">Services</a></li>
                    <li class="nav-item"><a class="nav-link" href="#contact">Qui sommes-nous ?</a></li>
                </ul>
            </div>
        </div>
    </nav>
